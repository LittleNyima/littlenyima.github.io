...
1. [教程 | Github Pages + hexo 搭建个人博客](../0-deploy-personal-blog-with-hexo)
2. [教程 | 利用 Github Actions 实现代码推送后自动部署](../1-auto-deployment-using-github-actions)
3. [技术相关 | Python 动画引擎 manim 浅度体验与思考](../2-a-taste-of-manim-and-reflections)
4. [技术相关 | 编译 Pytorch 扩展时替换 nvcc 版本](../5-replace-nvcc-while-building-extension)
5. [技术相关｜在内网搭建开发环境](../6-how-to-develop-on-the-intranet)
...
1. [笔记 | 一些乐理笔记汇总：基本概念](../3-basic-concepts-in-music-theory)
2. [杂谈 | 我为什么要写作](../4-the-reason-that-i-would-write)
3. [杂谈｜《波西米亚狂想曲》与流浪者](../7-bohemian-rhapsody-and-wanderer)
4. [杂谈｜还能不能完整听首歌了](../8-tiktok-is-ruining-pop-music)